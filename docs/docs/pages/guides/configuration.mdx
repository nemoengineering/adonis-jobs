...
As you can see, we are using the AdonisJS Health Check module, so make sure you check out the [documentation](https://docs.adonisjs.com/guides/digging-deeper/health-checks) for more details on it.
